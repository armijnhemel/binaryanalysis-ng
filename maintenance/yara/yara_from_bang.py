...
def remove_unpack(unpack_directory):
    shutil.rmtree(unpack_directory)

def generate_yara(yara_directory, package_name, functions, variables, strings):
    # open a rule
    ...
    meta:
        ...
        package_name = "%s"
        date = "%s"
''' % (package_name, package_name, generate_date)
...
def main():
    ...
    for bang_directory in result_directory.iterdir():
        ...
        yara_name = generate_yara(yara_directory, package_name, functions_per_package, variables_per_package, strings_per_package)
