...
CREATE TABLE IF NOT EXISTS apk_contents(apkname text, fullfilename text, filename text, sha256 text);
CREATE INDEX apk_contents_sha256 ON apk_contents USING HASH (sha256);
CREATE INDEX apk_contents_filename ON apk_contents USING HASH (filename);
