...
class TestGIF(TestBase):
    ...
    def x_test_cut_from_middle(self):
    ...
    def x_test_added_in_middle(self):
    ...
    def x_test_replaced_in_middle(self):
...
class TestPNG(TestBase):
    ...
    def x_test_prepended_apng(self):
        '''Test a single PNG with data appended'''
    ...
    # a test for the file being a single PNG with data cut from the end
    def x_test_cut_from_end_apng(self):
    ...
    def x_test_cut_from_middle_apng(self):
    ...
    def x_test_added_in_middle_apng(self):
    ...
    def x_test_replaced_in_middle_apng(self):
...
class TestSGI(TestBase):
    ...
    # a test for the file being a single SGI
    def x_test_fullfile_verbatim(self):
    ...
    # a test for the file being a single SGI with data appended to it
    def x_test_appended_verbatim(self):
    ...
    # a test for the file being a single SGI with data in front
    def x_test_prepended_verbatim(self):
    ...
    # a test for the file being a single SGI with data cut from the end
    def x_test_cut_from_end_verbatim(self):
    ...
    # a test for the file being a single SGI with data cut from the middle
    def x_test_cut_from_middle_verbatim(self):
    ...
    ## a test for the file being a single SGI with data added in the middle
    #def x_test_added_in_middle_verbatim(self):
    ...
    ## a test for the file being a single SGI with data replaced in the middle
    #def x_test_replaced_in_middle_verbatim(self):
...
# a test class for testing ICOs
class TestICO(TestBase):
    '''Test class for ICO image files'''
    ...
    # a test for the file being a single ICO with data cut from the end
    def x_test_cut_from_end_png(self):
        '''Test a single ICO with data cut from the end'''
    ...
    # a test for the file being a single ICO with data cut from the middle
    def x_test_cut_from_middle_png(self):
        '''Test a single ICO with data cut from the middle'''
    ...
    # a test for the file being a single ICO with data added in the middle
    def x_test_added_in_middle_png(self):
        '''Test a single ICO with data added in the middle'''
    ...
    # a test for the file being a single ICO with data replaced in the middle
    def x_test_replaced_in_middle_png(self):
        '''Test a single ICO with data replaced in the middle'''
...
class TestCPIO(TestBase):
    ...
    def x_test_cut_from_end_bin(self):
    ...
    # a test for the file being a single CPIO with data cut from the end
    def x_test_cut_from_end_old(self):
    ...
    # a test for the file being a single CPIO with data cut from the end
    def x_test_cut_from_end_new(self):
    ...
    # a test for the file being a single CPIO with data cut from the end
    def x_test_cut_from_end_crc(self):
    ...
    def x_test_cut_from_middle_bin(self):
    ...
    # a test for the file being a single CPIO with data cut from the middle
    def x_test_cut_from_middle_old(self):
    ...
    # a test for the file being a single CPIO with data cut from the middle
    def x_test_cut_from_middle_new(self):
    ...
    # a test for the file being a single CPIO with data cut from the middle
    def x_test_cut_from_middle_crc(self):
    ...
    def x_test_added_in_middle_bin(self):
    ...
    # a test for the file being a single CPIO with data added in the middle
    def x_test_added_in_middle_old(self):
    ...
    # a test for the file being a single CPIO with data added in the middle
    def x_test_added_in_middle_new(self):
    ...
    # a test for the file being a single CPIO with data added in the middle
    def x_test_added_in_middle_crc(self):
    ...
    def x_test_replaced_in_middle_bin(self):
    ...
    # a test for the file being a single CPIO with data replaced in the middle
    def x_test_replaced_in_middle_old(self):
    ...
    # a test for the file being a single CPIO with data replaced in the middle
    def x_test_replaced_in_middle_new(self):
    ...
    # a test for the file being a single CPIO with data replaced in the middle
    def x_test_replaced_in_middle_crc(self):
...
class TestXAR(TestBase):
    ...
    # now all the test cases.
    # a test for the file being a single xar
    def x_test_fullfile_bzip2(self):
    ...
    # now all the test cases.
    # a test for the file being a single xar
    def x_test_fullfile_no_compression(self):
    ...
    # a test for the file being a single xar with data appended to it
    def x_test_appended_bzip2(self):
    ...
    # a test for the file being a single xar with data appended to it
    def x_test_appended_no_compression(self):
    ...
    # a test for the file being a single xar with data in front
    def x_test_prepended_bzip2(self):
    ...
    # a test for the file being a single xar with data in front
    def x_test_prepended_no_compression(self):
    ...
    # a test for the file being a single xar with data cut from the end
    def x_test_cut_from_end_bzip2(self):
    ...
    # a test for the file being a single xar with data cut from the end
    def x_test_cut_from_end_no_compression(self):
    ...
    # a test for the file being a single xar with data cut from the middle
    def x_test_cut_from_middle_bzip2(self):
    ...
    # a test for the file being a single xar with data cut from the middle
    def x_test_cut_from_middle_no_compression(self):
    ...
    # a test for the file being a single xar with data added in the middle
    def x_test_added_in_middle_bzip2(self):
    ...
    # a test for the file being a single xar with data added in the middle
    def x_test_added_in_middle_no_compression(self):
    ...
    # a test for the file being a single xar with data replaced in the middle
    def x_test_replaced_in_middle_bzip2(self):
    ...
    # a test for the file being a single xar with data replaced in the middle
    def x_test_replaced_in_middle_no_compression(self):
...
class TestTar(TestBase):
    ...
    def x_test_fullfile_absolute(self):
    ...
    def x_test_fullfile_directories(self):
...
class TestJFFS2(TestBase):
    ...
    def x_test_fullfile_little(self):
    ...
    def x_test_appended_little(self):
    ...
    def x_test_prepended_to_little(self):
    ...
    # a test for the file being a single jffs2 with data in front
    def x_test_prepended_to_big(self):
    ...
    def x_test_cut_from_end_little(self):
    ...
    # a test for the file being a single jffs2 with data cut from the end
    def x_test_cut_from_end_big(self):
    ...
    def x_test_cut_from_middle_little(self):
    ...
    # a test for the file being a single jffs2 with data cut from the middle
    def x_test_cut_from_middle_big(self):
    ...
    def x_test_added_in_middle_little(self):
    ...
    # a test for the file being a single jffs2 with data added in the middle
    def x_test_added_in_middle_big(self):
    ...
    def x_test_replaced_in_middle_little(self):
    ...
    # a test for the file being a single jffs2 with data replaced in the middle
    def x_test_replaced_in_middle_big(self):
