meta:
  id: lz4_legacy_kernel
  title: LZ4 legacy format used in Linux kernel
  license: CC0-1.0
  endian: le
  encoding: ASCII
doc-ref:
  - https://github.com/lz4/lz4/blob/dev/doc/lz4_Frame_format.md#legacy-frame
  - https://github.com/armijnhemel/binaryanalysis-ng/issues/356
doc: |
...
seq:
  ...
  - id: blocks
    type: block
    repeat: until
    repeat-until: _io.eof or _.is_magic or _io.size - _io.pos <= 4
