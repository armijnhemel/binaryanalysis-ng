...
# * flag to indicate if it is a fatal error
#   (boolean)
def unpack_file_with_extension(fileresult, scanenvironment, filename, extension, unpack_directory, temporary_directory):
    return extensiontofunction[extension](fileresult, scanenvironment, filename, 0, unpack_directory, temporary_directory)
